...
export default function WhyUsSection() {
  return (
    <section className="py-24 bg-gradient-to-br from-slate-900 via-brand-900 to-slate-900 relative overflow-hidden">
      {/* Decorative blobs */}
      <div className="absolute -top-32 -right-32 w-64 h-64 bg-brand-500/20 rounded-full blur-3xl pointer-events-none animate-blob" />
      <div className="absolute -bottom-32 -left-32 w-64 h-64 bg-rose-500/20 rounded-full blur-3xl pointer-events-none animate-blob-delay" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <Reveal direction="left">
            <div>
              ...
              <h2 className="text-4xl font-bold text-white mb-6">
                Etkinliklerinizde{' '}
                <span className="gradient-text-animated">Fark Yaratan</span>{' '}
                Platform
              </h2>
              ...
              <a href="#iletisim" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-brand-500 to-rose-500 text-white font-semibold hover:from-brand-600 hover:to-rose-600 transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5 hover:scale-105">
          ...
          <div className="grid grid-cols-1 gap-4">
            {reasons.map((r, i) => (
              <Reveal key={r} direction="right" delay={i * 70}>
                <div className="flex items-start gap-3 p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/25 hover:translate-x-1 transition-all duration-300">
